...
<head>
  ...
  <script async src="https://www.googletagmanager.com/gtag/js?id=UA-175467192-1"></script>
  <script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());

    gtag('config', 'UA-175467192-1');
  </script>
...
<script>
  ...
  var id=button.data('id')
  var modal=$(this)
  modal.find('.modal-body #libcatedit').val(lib);
  modal.find('.modal-body #idcatedit').val(id);
      })
  </script>
<script>
...
var button = $(event.relatedTarget) // Button that triggered the modal
var lib=button.data('libart')
var id=button.data('id')
var modal=$(this)
modal.find('.modal-body #libartedit').val(lib);
modal.find('.modal-body #idartedit').val(id);
    })
</script>
<script>
$('#ViewCat').on('show.bs.modal', function (event) {

var button = $(event.relatedTarget) // Button that triggered the modal
var lib=button.data('libcat')
var id=button.data('id')
var modal=$(this)
modal.find('.modal-body #libcatview').val(lib);
modal.find('.modal-body #idcatview').val(id);
    })
</script>
...
var id=button.data('id')
var modal=$(this)
modal.find('.modal-body #libcatdelete').val(lib);
modal.find('.modal-body #idcatdelete').val(id);
    })
</script>
<!-- Categorie SCRIPTS -->
...
<script>
$('#deleteMode').on('show.bs.modal', function (event) {

var button = $(event.relatedTarget) // Button that triggered the modal
var lib=button.data('libcat')
var id=button.data('id')
var lien='/Retirer/Mode/'+id

var modal=$(this)
modal.find('.modal-body #libmodedelete').val(lib);
modal.find('.modal-body #idmodedelete').val(id);
modal.find('#lien').attr('href',lien);
console.log(lien);
    })
</script>
...
var button = $(event.relatedTarget) // Button that triggered the modal
var lib=button.data('libpro')
var id=button.data('id')
var cat_id=button.data('cat_id')

var modal=$(this)
modal.find('.modal-body #libproedit').val(lib);
modal.find('.modal-body #idproedit').val(id);
modal.find('.modal-body #idcatedit').val(cat_id);
...
var modal=$(this)
modal.find('.modal-body #libproview').val(lib);
modal.find('.modal-body #idproview').val(id);
modal.find('.modal-body #cat_idview').val(cat_id);
...
var modal=$(this)
modal.find('.modal-body #libprodelete').val(lib);
modal.find('.modal-body #idprodelete').val(id);
modal.find('.modal-body #cat_idelete').val(cat_id);
...
<script>
$('#editFrs').on('show.bs.modal', function (event) {
...
var modal=$(this)
modal.find('.modal-body #idfrsedit').val(id);
modal.find('.modal-body #namefrsedit').val(nom);
modal.find('.modal-body #repfrsedit').val(rep);
modal.find('.modal-body #ex-phoneedit').val(tel);
...
<script>
  $('#use1').on('show.bs.modal', function (event) {

var button = $(event.relatedTarget) // Button that triggered the modal
var lib=button.data('lib')
var id=button.data('id')
var lien='/Registre/destroy/'+id
var modal=$(this)
modal.find('.modal-body #LibTypeStructure').val(lib);
modal.find('.modal-body #idT').val(id);
modal.find('.supp').attr('href',lien);
 })
$('#user1').on('show.bs.modal', function (event) {
...
modal.find('.supp').attr('href',lien);
           ...
           $('#user2').on('show.bs.modal', function (event) {

var button = $(event.relatedTarget) // Button that triggered the modal
var lib=button.data('lib')
var id=button.data('id')
var lien='/Registre/active/'+id
var modal=$(this)
modal.find('.modal-body #LibTypeStructure').val(lib);
modal.find('.modal-body #idT').val(id);
modal.find('.supp').attr('href',lien);
 ...
 $('#recuser2').on('show.bs.modal', function (event) {
...
modal.find('.supp').attr('href',lien);
           ...
           $('#user3').on('show.bs.modal', function (event) {

var button = $(event.relatedTarget) // Button that triggered the modal
var lib=button.data('lib')
var id=button.data('id')
var lien='/Registre/nommer/'+id
var modal=$(this)
modal.find('.modal-body #LibTypeStructure').val(lib);
modal.find('.modal-body #idT').val(id);
modal.find('.supp').attr('href',lien);
      ...
      jQuery(document).ready(function(){
         jQuery('#ajaxSubmit').click(function(e){
            ...
            jQuery.ajax({
               ...
               method: 'post',
               data: {
                  mode_id: jQuery('#mode_id').val(),
                  vente_id: jQuery('#vente_id').val(),
                  montant: jQuery('#montanti').val(),
                  donne: jQuery('#donnei').val()
               },
               success: function(result){
                 jQuery('#closest').click();
                 $(function() {
...
var lien="/Voir/"+result.vente+"";
   ...
   <script>
         jQuery(document).ready(function(){
            jQuery('#addvente').click(function(e){
               ...
               jQuery.ajax({
                  ...
                  method: 'post',
                  data: {
                     mode_id: jQuery('#mode_idv').val(),
                     tva: jQuery('#tvav').val(),
                     donne: jQuery('#donnev').val()
                  },
                  success: function(result){
                    $(function() {
            const Toast = Swal.mixin({
